...
public class runner extends javax.swing.JFrame {
    ...
    public void zeichnen() {
        ...
        for (Spalte sp : feld.getBlocks()) {
            for (Block b : sp.getSpalte()) {
                ...
                zfeld.fillRect(height * i, jPanel1.getHeight() - (height * i2) - height, height, height);
                i2++;
            }
            i++;
            i2 = 0;
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        e = feld.CheckMate(e, feld.getBlocks().get(x).getSpalte().get(y), feld.getBlocks().get(x).getSpalte().get(y).getColor());
